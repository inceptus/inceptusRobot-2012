...
public class inceptusRobot extends IterativeRobot {
    ...
    private Jaguar leftRearDrive;
    private Jaguar rightRearDrive;
    private Jaguar leftFrontDrive;
    private Jaguar rightFrontDrive;
    ...
    public void robotInit() {
        ...
        leftRearDrive = new Jaguar(Constants.leftRearDrivePort);
        rightRearDrive = new Jaguar(Constants.rightRearDrivePort);
        leftFrontDrive = new Jaguar(Constants.leftFrontDrivePort);
        rightFrontDrive = new Jaguar(Constants.rightFrontDrivePort);
